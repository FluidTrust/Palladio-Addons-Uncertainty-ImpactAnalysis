...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.uncertainty.impact.uncertaintypropagation.UCImpactEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UCImpactEntityItemProvider extends AbstractModificationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UCImpactEntityItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((UCImpactEntity<?>)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UCImpactEntity_type") :
			getString("_UI_UCImpactEntity_type") + " " + label;
	}
