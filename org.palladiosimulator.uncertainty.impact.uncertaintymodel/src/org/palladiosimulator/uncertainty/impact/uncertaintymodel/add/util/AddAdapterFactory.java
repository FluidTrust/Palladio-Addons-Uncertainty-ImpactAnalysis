...
public class AddAdapterFactory extends AdapterFactoryImpl {
	...
	protected AddSwitch<Adapter> modelSwitch =
		new AddSwitch<Adapter>() {
			@Override
			public Adapter caseADDContainer(ADDContainer object) {
				return createADDContainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.uncertainty.impact.uncertaintymodel.add.ADDContainer <em>ADD Container</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createADDContainerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.palladiosimulator.uncertainty.impact.uncertaintymodel.add.ADD <em>ADD</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
