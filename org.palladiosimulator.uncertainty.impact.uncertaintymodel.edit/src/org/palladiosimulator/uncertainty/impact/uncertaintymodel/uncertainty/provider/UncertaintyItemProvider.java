...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.uncertainty.impact.uncertaintymodel.uncertainty.Uncertainty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UncertaintyItemProvider extends IdentifierItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addUncertaintyTypePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Uncertainty_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Uncertainty_name_feature", "_UI_Uncertainty_type"),
				 UncertaintyPackage.Literals.UNCERTAINTY__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Uncertainty Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUncertaintyTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Uncertainty_uncertaintyType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Uncertainty_uncertaintyType_feature", "_UI_Uncertainty_type"),
				 UncertaintyPackage.Literals.UNCERTAINTY__UNCERTAINTY_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UncertaintyPackage.Literals.UNCERTAINTY__ASSIGNED_ELEMENT);
		}
